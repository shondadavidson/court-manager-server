insert into notifications(tid, ref_id, court_num, type, message, time)
values (${tid}, ${ref_id},  (select court_num from courts where tournament_id = ${tid} and ref_id = ${ref_id}), '2nd', ${message}, now());
