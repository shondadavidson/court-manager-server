insert into notifications(tid, ref_id, type, message, court_num,   time)
values (${tid}, ${ref_id}, 'desk', ${message}, (select court_num from courts where tournament_id = ${tid} and ref_id = ${ref_id}), now());
